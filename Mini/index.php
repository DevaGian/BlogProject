...
<div class="container" id="sotto">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset" style="position:fixed;margin-top:100px">
            <h4>About</h4>
            <p>Etiam porta <em>sem malesuada magna</em> mollis euismod. Cras mattis consectetur purus sit amet fermentum. Aenean lacinia bibendum nulla sed consectetur.</p>
          </div>
          <div class="sidebar-module" style="position:fixed; margin-top:200px">
            <h4>Archives</h4>
          ...
          <div class="sidebar-module" style="position:fixed">
            <h4>Elsewhere</h4>
            <ol class="list-unstyled">
